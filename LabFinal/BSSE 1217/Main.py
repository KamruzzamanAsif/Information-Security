...
f = open("/home/asif_1217/Information-Security/LabFinal/BSSE 1217/input.txt", "r")
text = f.read()
f.close()
...
fout1 = open("/home/asif_1217/Information-Security/LabFinal/BSSE 1217/output1.txt", "w+")
fout1.write(cipher)
fout1.close()
...
fout2 = open("/home/asif_1217/Information-Security/LabFinal/BSSE 1217/output2.txt", "w+")
